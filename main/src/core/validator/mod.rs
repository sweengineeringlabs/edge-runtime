...
mod tests {
    ...
    /// @covers: ConfigValidator::validate — valid config passes
    #[test]
    fn test_validate_accepts_valid_config() {
        assert!(ConfigValidator.validate(&valid()).is_ok());
    }

    /// @covers: ConfigValidator::validate — empty http_bind rejected
    #[test]
    ...
    /// @covers: ConfigValidator::validate — empty grpc_bind rejected
    #[test]
    ...
    /// @covers: ConfigValidator::validate — zero timeout rejected
    #[test]
