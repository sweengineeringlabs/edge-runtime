...
/// @covers: EdgeRuntime::builder — builder is constructible with no arguments
#[test]
fn test_builder_creates_without_arguments() {
    let _builder = EdgeRuntime::builder();
}

/// @covers: EdgeRuntimeBuilder::config — accepted without error
#[test]
...
/// @covers: EdgeRuntimeBuilder::app_name — accepted without error
#[test]
fn test_builder_accepts_app_name() {
    let _builder = EdgeRuntime::builder().app_name("my-service");
}

/// @covers: EdgeRuntimeBuilder::http_tls — accepted without error
#[test]
...
/// @covers: EdgeRuntimeBuilder::grpc_tls — mTLS variant accepted
#[test]
...
/// @covers: EdgeRuntimeBuilder::grpc_allow_unauthenticated — chainable
#[test]
fn test_builder_grpc_allow_unauthenticated_is_chainable() {
    let _builder = EdgeRuntime::builder().grpc_allow_unauthenticated();
}

/// @covers: EdgeRuntimeBuilder::build_registry — None when no egress set
#[test]
