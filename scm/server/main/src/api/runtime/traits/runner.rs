...
/// Drives a [`RuntimeManager`](crate::RuntimeManager) through start → signal → shutdown.
pub trait Runner: Send + Sync {
    /// Drive the runtime through start → signal → shutdown.
    fn run(&self) -> RuntimeResult<()>;

    /// Construct a fresh [`RuntimeBuilder`](crate::RuntimeBuilder) via [`Runtime::builder`](crate::Runtime::builder).
    ...
    /// Return the zero-size [`Runtime`](crate::Runtime) entry-point.
    ...
    /// Return the zero-size [`ServerConfigLoader`](crate::ServerConfigLoader) factory.
    ...
    /// Return the zero-size [`ServerMonitor`](crate::ServerMonitor) factory.
    ...
    /// Return the zero-size [`TracingInitializer`](crate::TracingInitializer) factory.
    ...
    /// Return the zero-size [`RuntimeBuilderServe`](crate::RuntimeBuilderServe) marker.
